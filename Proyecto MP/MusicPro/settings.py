...
SECRET_KEY = 'django-insecure-vcx$14%uccu@9us7qa8a3ew3pko3*by#vd8k=frw0$xx99%l7i'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'producto.context_processor.total_dolar'
            ],
        },
    },
]
...
#STATIC_URL = 'static/'
#STATICFILES_DIRS = (os.path.join(BASE_DIR, 'MusicPro/static'),)
#MEDIA_URL = '/media/'
